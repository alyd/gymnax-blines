...
def get_model_ready(rng, config, speed=False):
    ...
    if config.env_name == 'MyContinuousMountainCar':
        env = MyContinuousMountainCar(**config.env_kwargs)
        env_params = env.default_params
    elif config.env_name == 'MyMountainCar':  
        env = MyMountainCar(**config.env_kwargs)
        env_params = env.default_params
    else:
